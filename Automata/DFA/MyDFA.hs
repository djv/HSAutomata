...
findValidTrans :: MyDFA -> StateLabel -> [Char]
...
predecessors :: MyDFA -> Char -> StateLabel -> StateSet
...
findEquivFrom :: MyDFA -> StateLabel -> StateSet -> Maybe StateLabel
